...
var Additems = exports.Additems = function (_Component11) {
	...
	function Additems(props) {
		...
		var _this15 = _possibleConstructorReturn(this, (Additems.__proto__ || Object.getPrototypeOf(Additems)).call(this, props));
		...
		value: function addItemEvent(e) {
			...
			if (!this.state.isFetching) {
				...
				(0, _actions.FetchPost)('/api/classify/addtag', { name: this.state.text }, function (data) {
					var newlist = _this17.state.data;
					newlist.push({
						id: data.info.id,
						name: data.info.name
					});
...
var ArticleFormUI = function (_Component2) {
	...
	_createClass(ArticleFormUI, [{
		...
		key: 'componentDidMount',
		value: function componentDidMount() {
			this.editor = (0, _editor2.default)('editorInitBox', {
				mode: 'html'
			});
		}
	}, {
		...
		toolsClickEvent: function toolsClickEvent(value) {
			...
			switch (value) {
				case '0':
					...
					break;
				case '1':
					dispatch((0, _actions.ActionGet)(_constants.UPDATE_COMMENT_STATE, '/api/comment/form_state/' + idArray.join(','), { state: 1 }, 'comment'));
					break;
				case '2':
					dispatch((0, _actions.ActionGet)(_constants.UPDATE_COMMENT_STATE, '/api/comment/form_state/' + idArray.join(','), { state: 0 }, 'comment'));
					break;
				default:
			}
		}
